...
<body>
	...
	<div class="body">
		...
		<section class="section-1">
			<h4 class="title">Modifier la tâche <a href="tasks.php">tâches</a></h4>
			<form class="form-1"
			      method="POST"
      	  ...
      	  <?php } ?>
				...
				<div class="input-holder">
					<lable>Somnoler</lable>
					<input type="date" name="due_date" class="input-1" placeholder="Somnoler" value="<?=$task['due_date']?>"><br>
				</div>
				
            <div class="input-holder">
					<lable>Attribué à</lable>
