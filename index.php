			...
			<?php if ($_SESSION['role'] == "admin") { ?>
				<div class="dashboard">
					<div class="dashboard-item">
						...
						<span><?=$num_users?> Employé</span>
					</div>
					<div class="dashboard-item">
						<i class="fa fa-tasks"></i>
						<span><?=$num_task?> Toutes les tâches</span>
					</div>
					<div class="dashboard-item">
					...
					<div class="dashboard-item">
						...
						<span><?=$nodeadline_task?> Pas de date limite</span>
					</div>
					<div class="dashboard-item">
						<i class="fa fa-exclamation-triangle"></i>
						<span><?=$todaydue_task?> À rendre aujourd'hui</span>
					</div>
					<div class="dashboard-item">
					...
					<div class="dashboard-item">
						...
						<span><?=$in_progress?> En cours</span>
					</div>
					<div class="dashboard-item">
						<i class="fa fa-check-square-o"></i>
						<span><?=$completed?> Complété</span>
					</div>
				</div>
			<?php }else{ ?>
				<div class="dashboard">
					<div class="dashboard-item">
						<i class="fa fa-tasks"></i>
						<span><?=$num_my_task?>Mes tâches</span>
					</div>
					<div class="dashboard-item">
						<i class="fa fa-window-close-o"></i>
						<span><?=$overdue_task?> En retard</span>
