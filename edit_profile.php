...
<body>
	...
	<div class="body">
		...
		<section class="section-1">
			<h4 class="title">Modifier le profil<a href="profile.php">Profile</a></h4>
         <form class="form-1"
			      method="POST"
      	  ...
      	  <?php } ?>
				<div class="input-holder">
					<lable>Nom et prénom</lable>
					<input type="text" name="full_name" class="input-1" placeholder="Nom et prénom" value="<?=$user['full_name']?>"><br>
				</div>
				...
				<div class="input-holder">
					<lable>Confirmez le mot de passe</lable>
